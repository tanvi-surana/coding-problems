...
*/	
	...
	public static boolean checkIfPalindrome1(node head)
	{
		if(head==null)
			return true;
		
		node middleElement=findMidLinkList(head);
		node middleNext=reverseIterative(middleElement.next);
		middleElement.next=null;
		while(middleElement!=null||middleNext!=null)
		{
			if(middleElement.data!=middleNext.data)
				return false;
   ...
   return head;
	...
	public static void main(String[] args)
	{
	   ...
	   System.out.println(checkIfPalindrome1(head));
		//	System.out.println( "\n"+findMidLinkList(head).data);
